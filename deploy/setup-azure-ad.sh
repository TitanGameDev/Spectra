...
set_backend_permissions() {
  ...
  local perms=(User.Read.All Reports.Read.All UserAuthenticationMethod.Read.All Policy.Read.All SecurityEvents.Read.All MailboxSettings.Read Application.Read.All RoleManagement.ReadWrite.Directory ReportSettings.ReadWrite.All Team.ReadBasic.All Channel.ReadBasic.All TeamMember.Read.All Sites.Read.All)
